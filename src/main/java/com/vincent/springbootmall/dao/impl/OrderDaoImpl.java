...
import com.vincent.springbootmall.rowmapper.OrderItemRowMapper;
import com.vincent.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public Integer createOrder(Integer userId, Integer totalAmount) {
        ...
        map.put("createdDate", current);
        map.put("lastModifiedDate", current);
...
//        System.out.println(orderItemList.get(0).getProductId());
        ...
        // 使用 for loop 一條一條 sql 加入數據，效率比較低
//        for (OrderItem orderItem : orderItemList) {
//
//            String sql = "INSERT INTO order_item(order_id, product_id, quanity, amount)" +
